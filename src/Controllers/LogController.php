...
class LogController extends Controller
{
    ...
    public function createLogWatcher(Request $request)
    {
         ...
         return $LogRepositoryContract->createLogWatcher($watcherName,$level,$integration,$identifier,$referenceType,$referenceValue,$emailTitle,$sendTo,$bcc,$cronIntervall);
    }
    ...
    public function updateLogWatcher(Request $request)
    {
        ...
        return $LogRepositoryContract->updateLogWatcher($id,$watcherName,$level,$integration,$identifier,$referenceType,$referenceValue,$emailTitle,$sendTo,$bcc,$cronIntervall,$lastRunAt);
    }
