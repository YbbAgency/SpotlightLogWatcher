...
class SpotlightLogWatcherLogRepository
{
     ...
     */
    public function createLogWatcher($watcherName,$level,$integration,$identifier,$referenceType,$referenceValue,$emailTitle,$sendTo,$bcc,$cronIntervall)
    {
     ...
     */
    public function updateLogWatcher($id,$watcherName,$level,$integration,$identifier,$referenceType,$referenceValue,$emailTitle,$sendTo,$bcc,$cronIntervall)
    {
        if($id > 0)
        {
            $database = pluginApp(DataBase::class);
